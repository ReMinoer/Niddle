...
namespace Niddle.Base
{
    public abstract class DependencyResolverBase : IDependencyResolver
    {
        ...
        public abstract bool TryResolve(out object obj, Type type, object key = null, InstanceOrigins origins = InstanceOrigins.All, IDependencyResolver resolver = null, IEnumerable<object> args = null);
        ...
        {
            if (TryResolve(out object temp, typeof(T), key, origins, resolver ?? this, args))
            {
                obj = (T)temp;
                return true;
            }
        ...
        {
            if (TryResolveMany(out IEnumerable enumerable, typeof(T), key, origins, resolver ?? this, args))
            {
